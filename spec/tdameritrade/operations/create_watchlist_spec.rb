    ...
    let(:expected_request_body) do
      {
        ...
        :watchlistItems=>
          [
            {:quantity=>0, :averagePrice=>0, :commission=>0, :purchasedDate=>"2019-08-25", :instrument=>{:symbol=>"AAPL", :assetType=>"EQUITY"}},
            {:quantity=>0, :averagePrice=>0, :commission=>0, :purchasedDate=>"2019-08-25", :instrument=>{:symbol=>"MSFT", :assetType=>"EQUITY"}},
            {:quantity=>0, :averagePrice=>0, :commission=>0, :purchasedDate=>"2019-08-25", :instrument=>{:symbol=>"VZ", :assetType=>"EQUITY"}}
          ]
      }.to_json
    end
